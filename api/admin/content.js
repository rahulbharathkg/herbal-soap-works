...
// import { requireAdmin, AuthRequest } from '../shared/auth';
const AdminContent_1 = require("../shared/AdminContent");
async function handler(req, res) {
    try {
        const dataSource = await (0, db_1.getDataSource)();
        const contentRepo = dataSource.getRepository(AdminContent_1.AdminContent);
        if (req.method === 'GET') {
